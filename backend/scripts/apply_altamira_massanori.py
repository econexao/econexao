"""Apply Altamira Praia do Massanori route and corridor associations (ECO-2626)."""
...
ROTA_MASSANORI_ID = "a17a314a-0000-4000-8000-000000000003"


def calculate_massanori_corridor(
    ...
    return {
        ...
        "route": "rota-massanori",
        "route_id": ROTA_MASSANORI_ID,
...
async def apply(dry_run: bool = False, db_url_override: str | None = None) -> int:
    ...
    logger.info("Computing Massanori corridor...")
    summary = calculate_massanori_corridor(csv_path, geoms_path)
    logger.info(
        "Massanori corridor: %d unique actors "
    ...
    out_summary = DATA_DIR / "massanori_ingestion_summary.json"
    ...
    migration_sql_path = (
        ROOT_DIR / "supabase" / "migrations" / "20260918193000_massanori_four_origins_route.sql"
    )
