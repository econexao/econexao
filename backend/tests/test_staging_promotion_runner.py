...
<<<<<<< HEAD
    """Baseline manifest must load successfully with 30 migrations."""
    manifest = load_canonical_migrations_manifest()
    assert manifest["total_migrations"] == 30
    assert len(manifest["migrations"]) == 30
=======
    """Baseline manifest must load successfully with 29 migrations."""
    manifest = load_canonical_migrations_manifest()
    assert manifest["total_migrations"] == 29
    assert len(manifest["migrations"]) == 29
>>>>>>> origin/staging
...
<<<<<<< HEAD
    assert len(sql_files) == 30
=======
    assert len(sql_files) == 29
>>>>>>> origin/staging
