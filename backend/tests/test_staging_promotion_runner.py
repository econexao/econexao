...
def test_load_canonical_migrations_manifest() -> None:
    """Baseline manifest must load successfully with 37 migrations."""
    manifest = load_canonical_migrations_manifest()
    assert manifest["total_migrations"] == 37
    assert len(manifest["migrations"]) == 37
