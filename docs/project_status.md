...
- **Evidência e limite:** Manifesto de release candidate, evidência ECO-2708 e relatório de revisão independente versionados. Branch de integração publicada na PR #70 com checks remotos aprovados. A5 registra que o bloqueio por avanço de base não é forçado por ruleset do GitHub (HTTP 404) e requer conferência operacional. Sem merge ou publicação remota nesta task.
