...
const TYPE_ICONS: Record<string, keyof typeof Ionicons.glyphMap> = {
  ...
  evento_cultural: 'musical-notes-outline',
  barraca_praia: 'umbrella-outline',
  cafe_lanchonete: 'cafe-outline',
  mercado_conveniencia: 'cart-outline',
  feira_livre: 'storefront-outline',
  comercio_local: 'storefront-outline',
  passeio_experiencia: 'boat-outline',
  trilha_ecoturismo: 'trail-sign-outline',
  agencia_turismo: 'briefcase-outline',
  guia_turismo: 'compass-outline',
  locacao_equipamentos: 'bicycle-outline',
  atrativo_natural: 'leaf-outline',
  praia_fluvial: 'sunny-outline',
  ilha: 'water-outline',
  serra_mirante: 'trail-sign-outline',
  unidade_conservacao: 'shield-checkmark-outline',
  patrimonio_cultural: 'business-outline',
  templo_religioso: 'home-outline',
  lazer_balneario: 'umbrella-outline',
  pousada_hotel: 'bed-outline',
  casa_temporada: 'home-outline',
  artesanato_local: 'color-palette-outline',
  terminal_aeroporto: 'airplane-outline',
  terminal_porto: 'boat-outline',
  terminal_rodoviario: 'bus-outline',
  catraia_travessia: 'boat-outline',
  posto_combustivel: 'car-outline',
  locadora_mobilidade: 'car-outline',
  farmacia: 'medkit-outline',
  hospital_upa: 'medical-outline',
  posto_saude_ubs: 'fitness-outline',
  seguranca_publica: 'shield-checkmark-outline',
  conselho_tutelar_protecao: 'scale-outline',
  servicos_publicos_cartorios: 'business-outline',
  comercio_eventos: 'storefront-outline',
