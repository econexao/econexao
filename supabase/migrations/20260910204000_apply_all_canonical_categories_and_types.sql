-- ECO-Expanded Taxonomy: Canonical 12 Categories, 38 Actor Types and Actor Reclassification
BEGIN;
...
-- 2. Insert or update all 12 canonical categories
...
BEGIN
    ...
    VALUES
        (v_alimentacao_id, 'restaurante', 'Restaurante & Gastronomia', 'utensils', 10, ARRAY['restaurante', 'restaurantes e bares', 'restaurantes e bares em santarém', 'restaurantes e bares em alter do chão', 'alimentacao', 'culinaria', 'gastronomia', 'comida regional', 'peixaria', 'self-service', 'churrascaria', 'pizzaria', 'bistrô', 'buffet'], 'route_corridor', 'Público se published. Selo SEMTUR se originário do inventário oficial.'),
        (v_alimentacao_id, 'barraca_praia', 'Barraca de Praia & Quiosque', 'umbrella', 12, ARRAY['barraca de praia', 'quiosque', 'cabana de praia', 'restaurante de praia', 'apoio de praia', 'barraca', 'restaurantes e bares na praia do maracanã', 'restaurantes e bares em ponta de pedras', 'restaurantes e bares em carapanari', 'restaurantes e bares em pajuçara'], 'route_corridor', 'Público se published. Relevância máxima no corredor de praias (Pindobal / Alter).'),
        ...
        (v_atrativos_id, 'unidade_conservacao', 'Unidade de Conservação & APA', 'shield-check', 24, ARRAY['unidade de conservação', 'unidade de conservacao', 'área de proteção ambiental', 'area de protecao ambiental', 'apa', 'flona tapajós', 'parna', 'resex tapajós-arapiuns', 'parque ambiental', 'uc'], 'both', 'Público institucional (published). Máxima relevância socioambiental.'),
        (v_atrativos_id, 'patrimonio_cultural', 'Patrimônio Cultural & Histórico', 'landmark', 25, ARRAY['edificações e arquiteturas', 'edificacoes e arquiteturas', 'obras de arte', 'instituições culturais', 'instituicoes culturais', 'bibliotecas', 'patrimonio', 'centro cultural', 'museu', 'monumento', 'teatro'], 'both', 'Público institucional (published). Selo SEMTUR.'),
        ...
        (v_atrativos_id, 'lazer_balneario', 'Balneário & Clube de Lazer', 'umbrella', 27, ARRAY['balneários/chácaras', 'balnearios/chacaras', 'balneário', 'chácara', 'clubes sociais, desportivos e de lazer', 'serviços/equipamentos de lazer', 'servicos/equipamentos de lazer', 'parque aquático', 'clube'], 'route_corridor', 'Público se published.'),
        ...
        (v_comercio_id, 'comercio_local', 'Lojas & Comércio Local', 'store', 52, ARRAY['loja', 'lojas', 'shopping', 'shopping/lojas de departamento', 'comercio', 'vestuário', 'calçados', 'produtos regionais', 'decoração'], 'both', 'Público se published.'),
        (v_experiencias_id, 'passeio_experiencia', 'Passeio Náutico & Vivência', 'ship', 60, ARRAY['passeios de barco', 'passeio de barco', 'passeio nautico', 'passeios náuticos', 'lanchas em alter do chão', 'lanchas em alter do chao e rios amazonas e tapajós', 'vivência', 'vivencia comunitaria', 'turismo de base comunitaria', 'turismo comunitário', 'observação de botos', 'expedição', 'roteiro guiado', 'passeio', 'passeios'], 'route_corridor', 'Público se published. Vivências e passeios turísticos guiados no Tapajós e Arapiuns.'),
        ...
        (v_servicos_turisticos_id, 'agencia_turismo', 'Agência de Turismo & Receptivo', 'briefcase', 80, ARRAY['agências', 'agencia', 'agências de passagens aéreas', 'agencias de passagens aereas', 'receptivo', 'operadora de turismo'], 'both', 'Público se published.'),
        ...
        (v_transporte_id, 'terminal_rodoviario', 'Rodoviária & Transporte Coletivo', 'bus', 92, ARRAY['rodoviaria', 'terminal rodoviario', 'ponto de onibus', 'vans', 'vans e micro-ônibus', 'transporte intermunicipal', 'transfer', 'coletivo', 'transporte intermunicipal, interestadual e urbano'], 'both', 'Público institucional (published). Origem canônica do contrato de rota.'),
        ...
        (v_transporte_id, 'locadora_mobilidade', 'Locadora de Veículos & Táxi', 'car', 95, ARRAY['locadoras de veículos', 'locadoras de veiculos', 'locadora veículos', 'aluguel de carro', 'rent a car', 'taxi', 'mototaxi', 'ponto de taxi'], 'both', 'Público se published.'),
        ...
        (v_outros_id, 'comercio_eventos', 'Comércio & Serviços para Eventos', 'store', 121, ARRAY['para eventos', 'serviços para eventos', 'serviços/equipamentos para eventos', 'decoração', 'som e iluminação'], 'both', 'Curadoria Editorial (review / published se auditado).'),
    ...
    -- Backfill type_id and update category_id for actors based on sub_category and aliases
    ...
    -- Reclassify existing actors based on their assigned type_id
